        ...
        this.actions$.pipe(
            ...
            mergeMap(() =>
                this.offersService.getOffers().pipe(
                    ...
                    // If the API call succeeds, extract the 'offers' property and dispatch the 'loadOffersSuccess' action
                    map((response) => OffersActions.loadOffersSuccess({ offers: response.offers })),
